<?php
/**
 * Title: Footer with Costard Cravate branding (dark)
...
<div class="wp-block-group alignfull has-background-color has-base-color has-contrast-background-color has-text-color has-background has-link-color has-small-font-size" style="margin-top:0px;padding-top:var(--wp--preset--spacing--small);padding-right:30px;padding-bottom:var(--wp--preset--spacing--small);padding-left:30px">
	...
	<div class="wp-block-group alignwide">
		<!-- wp:paragraph -->
		<p>&copy; <?php echo esc_html( gmdate( 'Y' ) ); ?> <?php echo esc_html__( 'Costard Cravate. Crafting packaging experiences.', 'frost' ); ?></p>
		<!-- /wp:paragraph -->
		<!-- wp:paragraph -->
		<p><a href="#"><?php echo esc_html__( 'Instagram', 'frost' ); ?></a> · <a href="#"><?php echo esc_html__( 'Pinterest', 'frost' ); ?></a> · <a href="#"><?php echo esc_html__( 'Behance', 'frost' ); ?></a></p>
		<!-- /wp:paragraph -->
	</div>
	<!-- /wp:group -->
</div>
